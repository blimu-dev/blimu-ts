  ...
  ({ addBase }) => {
    ...
    addBase({
      ':root': {
        ...
        '--blimu-foreground': 'oklch(0.141 0.005 285.823)',
        '--blimu-card': 'oklch(1 0 0)',
        '--blimu-card-foreground': 'oklch(0.141 0.005 285.823)',
        '--blimu-popover': 'oklch(1 0 0)',
        '--blimu-popover-foreground': 'oklch(0.141 0.005 285.823)',
        '--blimu-primary': 'oklch(0.21 0.006 285.885)',
        '--blimu-primary-foreground': 'oklch(0.985 0 0)',
        '--blimu-secondary': 'oklch(0.967 0.001 286.375)',
        '--blimu-secondary-foreground': 'oklch(0.21 0.006 285.885)',
        '--blimu-muted': 'oklch(0.967 0.001 286.375)',
        '--blimu-muted-foreground': 'oklch(0.552 0.016 285.938)',
        '--blimu-accent': 'oklch(0.967 0.001 286.375)',
        '--blimu-accent-foreground': 'oklch(0.21 0.006 285.885)',
        '--blimu-destructive': 'oklch(0.577 0.245 27.325)',
        '--blimu-destructive-foreground': 'oklch(0.577 0.245 27.325)',
        '--blimu-border': 'oklch(0.92 0.004 286.32)',
        '--blimu-input': 'oklch(0.92 0.004 286.32)',
        '--blimu-ring': 'oklch(0.705 0.015 286.067)',
        ...
        '--blimu-sidebar-foreground': 'oklch(0.141 0.005 285.823)',
        '--blimu-sidebar-primary': 'oklch(0.21 0.006 285.885)',
        '--blimu-sidebar-primary-foreground': 'oklch(0.985 0 0)',
        '--blimu-sidebar-accent': 'oklch(0.967 0.001 286.375)',
        '--blimu-sidebar-accent-foreground': 'oklch(0.21 0.006 285.885)',
        '--blimu-sidebar-border': 'oklch(0.92 0.004 286.32)',
        '--blimu-sidebar-ring': 'oklch(0.705 0.015 286.067)',
      },
      '.dark': {
        '--blimu-background': 'oklch(0.141 0.005 285.823)',
        '--blimu-foreground': 'oklch(0.985 0 0)',
        '--blimu-card': 'oklch(0.21 0.006 285.885)',
        '--blimu-card-foreground': 'oklch(0.985 0 0)',
        '--blimu-popover': 'oklch(0.21 0.006 285.885)',
        '--blimu-popover-foreground': 'oklch(0.985 0 0)',
        '--blimu-primary': 'oklch(0.92 0.004 286.32)',
        '--blimu-primary-foreground': 'oklch(0.21 0.006 285.885)',
        '--blimu-secondary': 'oklch(0.274 0.006 286.033)',
        '--blimu-secondary-foreground': 'oklch(0.985 0 0)',
        '--blimu-muted': 'oklch(0.274 0.006 286.033)',
        '--blimu-muted-foreground': 'oklch(0.705 0.015 286.067)',
        '--blimu-accent': 'oklch(0.274 0.006 286.033)',
        '--blimu-accent-foreground': 'oklch(0.985 0 0)',
        '--blimu-destructive': 'oklch(0.704 0.191 22.216)',
        '--blimu-destructive-foreground': 'oklch(0.704 0.191 22.216)',
        '--blimu-border': 'oklch(1 0 0 / 10%)',
        '--blimu-input': 'oklch(1 0 0 / 15%)',
        '--blimu-ring': 'oklch(0.552 0.016 285.938)',
        ...
        '--blimu-sidebar': 'oklch(0.21 0.006 285.885)',
        '--blimu-sidebar-foreground': 'oklch(0.985 0 0)',
        '--blimu-sidebar-primary': 'oklch(0.488 0.243 264.376)',
        '--blimu-sidebar-primary-foreground': 'oklch(0.985 0 0)',
        '--blimu-sidebar-accent': 'oklch(0.274 0.006 286.033)',
        '--blimu-sidebar-accent-foreground': 'oklch(0.985 0 0)',
        '--blimu-sidebar-border': 'oklch(1 0 0 / 10%)',
        '--blimu-sidebar-ring': 'oklch(0.552 0.016 285.938)',
      },
    });
  },
  {
