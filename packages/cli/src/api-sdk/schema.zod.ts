...
/**
 * Zod schema for DefinitionGenerateSDKRequestDto
 */
export const DefinitionGenerateSDKRequestDtoSchema = z.object({
  entitlements: z
    .record(
      z.string(),
      z.object({
...
/**
 * Zod schema for DefinitionGenerateSDKResponseDto_Output
 */
export const DefinitionGenerateSDKResponseDto_OutputSchema = z.object({
  errors: z
    .object({
      field: z.string(),
      message: z.string(),
